/**
 * Standalone health check test that doesn't rely on any shared setup file
 * This should work even if there are issues with other tests
 */
...
describe('Standalone API Health Check', () => {
